...
public class TRNReactNativeViewManager extends ViewGroupManager<TRNReactNativeSignatureMainView> {
    ...
    private TRNReactNativeContextModule mContextModule;

    public TRNReactNativeViewManager(ReactApplicationContext reactContext) {
        mContextModule = new TRNReactNativeContextModule(reactContext);
    }

    @Override
    public String getName() {
        return "TRNSignaturePad";
    }

    @ReactProp(name = PROPS_SAVE_IMAGE_FILE)
    public void setSaveImageFileInExtStorage(TRNReactNativeSignatureMainView view, @Nullable Boolean saveFile) {
    ...
    public void setViewMode(TRNReactNativeSignatureMainView view, @Nullable String viewMode) {
    ...
    public void setPropsShowNativeButtons(TRNReactNativeSignatureMainView view, @Nullable Boolean showNativeButtons) {
    ...
    public void setPropsWidth(TRNReactNativeSignatureMainView view, @Nullable Integer maxSize) {
    ...
    public void setPropsMinStrokeWidth(TRNReactNativeSignatureMainView view, @Nullable int minStrokeWidth) {
    ...
    public void setPropsMaxStrokeWidth(TRNReactNativeSignatureMainView view, @Nullable int maxStrokeWidth) {
    ...
    public void setPropsStrokeColor(TRNReactNativeSignatureMainView view, @Nullable String color) {
    ...
    public void setPropsBackgroundColor(TRNReactNativeSignatureMainView view, @Nullable String color) {
    ...
    @Override
    public TRNReactNativeSignatureMainView createViewInstance(ThemedReactContext context) {
        Log.d("React"," View manager createViewInstance:");
        return new TRNReactNativeSignatureMainView(context, mContextModule.getActivity());
    }
    ...
    public void receiveCommand(
            TRNReactNativeSignatureMainView view,
            int commandType,
