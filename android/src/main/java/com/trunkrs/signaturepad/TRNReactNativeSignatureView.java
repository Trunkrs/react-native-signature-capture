...
import com.trunkrs.signaturepad.utils.TimedPoint;
import com.trunkrs.signaturepad.utils.ControlTimedPoints;
import com.trunkrs.signaturepad.utils.Bezier;

public class TRNReactNativeSignatureView extends View {
    ...
    public TRNReactNativeSignatureView(Context context, SignatureCallback callback) {
    ...
    public void sendDragEndEventToReact() {
        if (callback != null && dragged) {
            callback.onDragEnd();
        }
    }
