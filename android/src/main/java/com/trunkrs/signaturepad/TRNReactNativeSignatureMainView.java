...
public class TRNReactNativeSignatureMainView extends LinearLayout implements OnClickListener, TRNReactNativeSignatureView.SignatureCallback {
    LinearLayout buttonsLayout;
    TRNReactNativeSignatureView signatureView;
    ...
    public TRNReactNativeSignatureMainView(Context context, Activity activity) {
        super(context);
        Log.d("React:", "RSSignatureCaptureMainView(Contructor)");
        mOriginalOrientation = activity.getRequestedOrientation();
        mActivity = activity;

        this.setOrientation(LinearLayout.VERTICAL);
        this.signatureView = new TRNReactNativeSignatureView(context,this);
    ...
    public TRNReactNativeSignatureView getSignatureView() {
    ...
    protected void emitEvent(String name, @Nullable WritableMap eventArgs) {
        WritableMap arguments = eventArgs == null
                ? Arguments.createMap()
                : eventArgs;

        arguments.putString("eventType", name);
        ReactContext reactContext = (ReactContext) getContext();
        reactContext.getJSModule((RCTEventEmitter.class))
                .receiveEvent(getId(), "topChange", arguments);
    }
}